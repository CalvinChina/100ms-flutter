...
#ifndef HMSSDK_FLUTTER_SWIFT_H
#define HMSSDK_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hmssdk_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14hmssdk_flutter24SwiftHmssdkFlutterPlugin")
@interface SwiftHmssdkFlutterPlugin : NSObject <FlutterPlugin, FlutterStreamHandler, HMSLogger, HMSPreviewListener, HMSUpdateListener>
...
@interface SwiftHmssdkFlutterPlugin (SWIFT_EXTENSION(hmssdk_flutter)) <AVPictureInPictureControllerDelegate>
